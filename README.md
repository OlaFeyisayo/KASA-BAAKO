...
- [ ] **Khaya "Developer" plan is capped at 100 calls/month** (shared across ASR+TTS, across all 3 of us testing) — could run out before the demo. Verified current pricing (Sept 16) directly on khaya.ai/pricing: Developer (free) = 100 calls/mo, **Basic = $14.95/mo for 3,000 calls/mo**, Standard = $89.95/mo for 20,000, Enterprise = $749/mo for 200,000 — no tier is unlimited. Basic is the right fit here (30x the free quota, plenty for testing + the demo); our professors have offered to cover the cost.
